 ...
 * <ul>
 *   <li>{@link Trialple.impl.UnitDefImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link Trialple.impl.UnitDefImpl#getName <em>Name</em>}</li>
 *   <li>{@link Trialple.impl.UnitDefImpl#getSrcid <em>Srcid</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnitDefImpl extends MinimalEObjectImpl.Container implements UnitDef {
	...
	protected EClass eStaticClass() {
		return TrialplePackage.Literals.UNIT_DEF;
	}
	...
	public EList<Unit> getUnit() {
		if (unit == null) {
			unit = new EObjectContainmentEList<Unit>(Unit.class, this, TrialplePackage.UNIT_DEF__UNIT);
		}
		return unit;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TrialplePackage.UNIT_DEF__NAME, oldName, name));
	}
	...
	public void setSrcid(String newSrcid) {
		...
		srcid = newSrcid;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TrialplePackage.UNIT_DEF__SRCID, oldSrcid, srcid));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TrialplePackage.UNIT_DEF__UNIT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TrialplePackage.UNIT_DEF__UNIT:
				return getUnit();
			case TrialplePackage.UNIT_DEF__NAME:
				return getName();
			case TrialplePackage.UNIT_DEF__SRCID:
				return getSrcid();
		}
