...
/**
 * This is the item provider adapter for a {@link Trialple.And} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AndItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TrialplePackage.Literals.AND__OPTION);
			childrenFeatures.add(TrialplePackage.Literals.AND__OR);
			childrenFeatures.add(TrialplePackage.Literals.AND__NOT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TrialplePackage.Literals.AND__OPTION,
				 TrialpleFactory.eINSTANCE.createOption()));

		newChildDescriptors.add
			(createChildParameter
				(TrialplePackage.Literals.AND__OR,
				 TrialpleFactory.eINSTANCE.createOr()));

		newChildDescriptors.add
			(createChildParameter
				(TrialplePackage.Literals.AND__NOT,
