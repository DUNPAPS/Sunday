...
/**
 * This is the item provider adapter for a {@link Trialple.IfType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IfTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IfType_test_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IfType_test_feature", "_UI_IfType_type"),
				 TrialplePackage.Literals.IF_TYPE__TEST,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TrialplePackage.Literals.IF_TYPE__PHASE);
			childrenFeatures.add(TrialplePackage.Literals.IF_TYPE__OPTIONS);
			childrenFeatures.add(TrialplePackage.Literals.IF_TYPE__SUBMODULEREF);
		}
	...
	public String getText(Object object) {
		String label = ((IfType)object).getTest();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TrialplePackage.Literals.IF_TYPE__PHASE,
				 TrialpleFactory.eINSTANCE.createPhase()));

		newChildDescriptors.add
			(createChildParameter
				(TrialplePackage.Literals.IF_TYPE__OPTIONS,
				 TrialpleFactory.eINSTANCE.createOptList()));

		newChildDescriptors.add
			(createChildParameter
				(TrialplePackage.Literals.IF_TYPE__SUBMODULEREF,
